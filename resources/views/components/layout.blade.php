...
<body
    style="margin: 0; padding: 0; background-color: #ffffff; font-family: 'Helvetica Neue', Arial, sans-serif; box-sizing: border-box;">

    <header style="background: #000; color: #fff; width: 100%;">
        <div
            style="width: 100%; padding: 15px 40px; box-sizing: border-box; display: flex; align-items: center; justify-content: space-between;">
            ...
            <nav style="display: flex; gap: 25px; align-items: center; margin-left: 20px;">
                @auth
                    ...
                    <a href="/mypage" style="color: #fff; text-decoration: none; font-size: 16px;">マイページ</a>
                    <a href="/sell"
                        style="background: #fff; color: #000; padding: 6px 20px; border-radius: 4px; text-decoration: none; font-weight: bold; font-size: 16px;">出品</a>
                @else
    ...
    <main style="width: 100%; padding: 40px; box-sizing: border-box;">
        {{ $slot }}
    </main>
